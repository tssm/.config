...
nnoremap <c-g> :execute 'echo "' . GetCurrentDir() . GetGitBranch() '"'<cr>
...
augroup DirvishSetUp
	...
	autocmd FileType dirvish
		...
		\ nnoremap <buffer> <silent> + :lua require('procedures')['create-file'](vim.call("bufname"))<cr>
augroup END
...
augroup SignifySetup
	...
	autocmd User SignifySetup
		...
		\ nmap ]H 9999]h |
		\ nmap [H 9999[h |
		\ nmap <localleader>df :SignifyDiff<cr>|
		\ nmap <localleader>dh :SignifyHunkDiff<cr>|
		\ nmap <localleader>uh :SignifyHunkUndo<cr>
